...
export async function POST(req: Request) {
  try {
    ...
    // TASK 1 FIX: DB-native scalable search.
    // Instead of pulling thousands of feedback rows into Node.js memory,
    // we perform native PostgreSQL indexed search filtered by workspaceId.
